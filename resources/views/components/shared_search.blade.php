<nav class="navbar">
    <form class="form-inline" method="GET" action="{{ route('visualizzatore.search') }}" id="searchForm">
            ...
            <div class="custTableSrchChldBtm">
                <div class="custTableSrchChldBtmFrm">
                                ...
                                <div>
                                    ...
                                    <div class="select-dropdown">
                                        <div class="item-search">
                                            <input autocomplete="off" placeholder="search..." id="file-type-search" data-user="Visualizzatore">
                                        </div>
                    ...
                    {{-- <div class="custTableSrchChldBtmFrmRpt">
                        ...
                        <div class="custTableSrchChldBtmFrmRptRt">
                            <div class="select">
                                ...
                                <div>
                                    <div class="selected" id="owner" data-user="Visualizzatore">
                                        <span><img src="{{ asset('assets/images/iconPolygon.svg') }}"
                                                alt=""></span>
                                    ...
                                    <div class="select-dropdown">
                                        <div class="item-search">
                                            <input autocomplete="off" placeholder="search..." id="owner-search" data-user="Visualizzatore">
                                        </div>
                    ...
                    <div class="custTableSrchChldBtmFrmRpt">
                        ...
                        <div class="custTableSrchChldBtmFrmRptRt">
                            <div class="select" id="folder" data-user="Visualizzatore">
                                <select name="folder">
                                ...
                                <div>
                                    ...
                                    <div class="select-dropdown">
                                        <div class="item-search">
                                            <input autocomplete="off" placeholder="search..." id="folder-search" data-user="Visualizzatore">
                                        </div>
                    ...
                    <div class="custTableSrchChldBtmFrmRpt">
                        <div class="SrchBarFlterBtns">
                            <a href="{{ route('shared') }}" class="custRstBtn">Reset</a>
                            <button class="custSrchBtn" type="submit">Search <img
                                    src="{{ asset('assets/images/iconRightSearch.svg') }}" alt=""></button>
                        </div>
                    </div>
...
<div class="custFilterFrSrch">
    <form class="form-inline" method="GET" action="{{ route('visualizzatore.search') }}" id="custom-search-form">
        <ul>
            <li>
                <div class="select">
                    <select name="file_type">
                    ...
                    <div>
                        ...
                        <div class="select-dropdown">
                            <div class="item-search">
                                <input autocomplete="off" placeholder="search..." id="custom_file_type_search" data-user="Visualizzatore">
                            </div>
                            <div class="file_type_item_list item-list">
                                @foreach ($fileType as $file)
                                    <div class="items" data-value="{{ $file->guid }}">
            ...
            {{-- <li>
                <div class="select">
                    ...
                    <div>
                        <div class="selected" id="custom_owner" data-user="Visualizzatore">
                            <span><img src="{{ asset('assets/images/iconDownWt.svg') }}" alt=""></span>
                            @if (!empty($modifiedFields['owner']))
                                <div>{{ $modifiedFields['owner'] }}</div>
                            @else
                        ...
                        <div class="select-dropdown">
                            <div class="item-search">
                                <input autocomplete="off" placeholder="search..." id="custom_owner_search" data-user="Visualizzatore">
                            </div>
            ...
            <li>
                <div class="select">
                    ...
                    <div>
                        <div class="selected" id="custom_folder" data-user="Visualizzatore">
                            <span><img src="{{ asset('assets/images/iconDownWt.svg') }}" alt=""></span>
                            @if (!empty($modifiedFields['folder']))
                                <div>{{ $modifiedFields['folder'] }}</div>
                            @else
                        ...
                        <div class="select-dropdown">
                            <div class="item-search">
                                <input autocomplete="off" placeholder="search..." id="custom_folder_search" data-user="Visualizzatore">
                            </div>
