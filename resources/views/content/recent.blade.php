...
@section('content')
    <!-- Main section for displaying recent files -->
                            ...
                            <div class="custFilterTable">
                                ...
                                <div class="custFilterTableMn">
                                    <div class="table-responsive">
                                        <!-- Table for listing recent files -->
                                        <table class="table table-bordered">
                                            @if (isset($files) && $files->isNotEmpty())
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="name"
                                                            ...
                                                            <a href="{{ route('recent', ['order' => request('order') === 'asc' ? 'desc' : 'asc', 'sort' => 'name']) }}">Name
                                                        ...
                                                        <th class="sort" data-sort="user_order"
                                                            ...
                                                            <a href="{{ route('recent', ['user_order' => request('user_order') === 'asc' ? 'desc' : 'asc', 'user_sort' => 'name']) }}">Owner
                                                        ...
                                                        <th class="sort" data-sort="updated_at"
                                                            data-order="{{ request('order') === 'asc' ? 'desc' : 'asc' }}">
                                                            <a href="{{ route('recent', ['order' => request('order') === 'asc' ? 'desc' : 'asc', 'sort' => 'updated_at']) }}">Date Modified
                                                ...
                                                <tbody class="content-list">
                                                    <!-- Loop through each recent file -->
                                                    @if ($files->isNotEmpty())
                                                        @foreach ($files as $file)
                                                            <tr>
                                                                <td><b><img src="{{ $file->svgPath }}"
                                                                            alt="{{ $file->extension }}"
                                                                            style="width: 20px; height: 20px;">
                                                                        {{ $file->name }}</b></td>
                                                                <td><img src="{{ $file->user->avatar ? $file->user->avatar : asset('assets/images/iconProfile.png') }}"
                                                                        class="UsrImg">
                                                                ...
                                                                <td>
                                                                    @if ($file->parent)
                                                                        @if ($file->parent->is_folder == 1)
                                                                            <!-- Link to parent folder if available -->
                                                                            <a class="custmclckbtnshared"
                                                                                href="{{ route('list.contents.folder', $file->parent->guid) }}">
                                                                        ...
                                                                        @else
                                                                            ...
                                                                            <img src="{{ $file->parent->svgPath ? asset($file->parent->svgPath) : asset('assets/images/folder.svg') }}"
                                                                                alt="{{ $file->parent->extension }}"
                                                                                style="width: 20px; height: 20px;">
                                                                            {{ $file->parent->name }}
                                                                        @endif
                                                                    @else
                                                                            ...
                                                                            <div class="custShrDvCld">
                                                                                <ul>
                                                                                            ...
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="javascript:void(0);"
                                                                                                        ...
                                                                                                        data-folder-guid="{{ $file->guid }}"
                                                                                                        data-folder-name = "{{ $file->name }}">
                                                                                                        <img src="{{ asset('assets/images/iconFolder.svg') }}"
                                                                                                            alt="Move">
                                                                                                        Select Folder
                                                                                                    </a>
                                                                                    ...
                                                                                    @if ($file->is_folder == 0)
                                                                                        ...
                                                                                        <li>
                                                                                            <a href="{{ route('content.download', ['guid' => $file->guid]) }}"
                                                                                                target="_blank"
                                                                                                data-file-guid="{{ $file->guid }}">
                                                                                    ...
                                                                                    @can('content-copy')
                                                                                        ...
                                                                                        <li>
                                                                                            <form
                                                                                                action="{{ route('content.makeCopy', $file->guid) }}"
                                                                                                method="POST"
                                                                                                class="make-copy-form-folder"
                                                                                                data-folder-id="{{ $file->guid }}">
                                                                                                @csrf
                                                                                                @method('POST')
                                                                                                <button type="submit"
                                                                                    ...
                                                                                    @can('content-delete')
                                                                                        ...
                                                                                        <li>
                                                                                            <form
                                                                                                action="{{ route('content.moveToTrash', $file->guid) }}"
                                                                                                method="POST"
                                        ...
                                        <div class="d-flex justify-content-center">
                                            {{ $files->appends(request()->except('page'))->links('pagination::bootstrap-4') }}
                                        </div>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        Swal.fire({
                            title: 'Success',
                            text: "Content moved to trash successfully!",
                            icon: 'success',
                            confirmButtonText: 'OK'
                        }).then(() => {
