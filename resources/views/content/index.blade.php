<!-- Main dashboard view for listing folders and files -->
@extends('layouts.app')
...
@section('content')
    ...
    <!-- Main content section for the right bar -->
                    ...
                    <div class="col-xxl-12">
                        <div class="custTableSrch">
                            ...
                            <div class="custFilterTable">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb custom-breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="{{ route('list.contents') }}">My folders</a>
                                            </li>
                                            ...
                                            @foreach ($parents as $parent)
                                                <li class="breadcrumb-item">
                                                    ...
                                                    @else
                                                        <a
                                                            href="{{ route('list.contents.folder', $parent['guid']) }}">{{ $parent['name'] }}</a>
                                                        <!-- Parent folder link -->
                                                    @endif
                                                </li>
                                            @endforeach
                                ...
                                <!-- Folder or file list heading -->
                                <div class="custFilterTabledng">
                                    @if ($current_content)
                                        <h3>{{ $current_content->name }}</h3>
                                    @else
                                        <h3>My Folders</h3>
                                    @endif
                                </div>

                                <!-- Main table for listing contents -->
                                        ...
                                        <table class="table table-bordered">
                                            @if ($contents->isNotEmpty())
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="name"
                                                            ...
                                                            <a href="{{ request()->is('folder/*') ? route('list.contents.folder', [$currentFolderGuid, 'order' => request('order') === 'asc' ? 'desc' : 'asc', 'sort' => 'name']) : route('list.contents', ['order' => request('order') === 'asc' ? 'desc' : 'asc', 'sort' => 'name']) }}">
                                                                Name
                                                        ...
                                                        <th class="sort" data-sort="user_order"
                                                            ...
                                                            <a href="{{ request()->is('folder/*') ? route('list.contents.folder', [$currentFolderGuid, 'user_order' => request('user_order') === 'asc' ? 'desc' : 'asc', 'user_sort' => 'name']) : route('list.contents', ['user_order' => request('user_order') === 'asc' ? 'desc' : 'asc', 'user_sort' => 'name']) }}">
                                                                Owner
                                                        ...
                                                        <th class="sort" data-sort="updated_at"
                                                            data-order="{{ request('order') === 'asc' ? 'desc' : 'asc' }}">
                                                            <a href="{{ request()->is('folder/*') ? route('list.contents.folder', [$currentFolderGuid, 'order' => request('order') === 'asc' ? 'desc' : 'asc', 'sort' => 'updated_at']) : route('list.contents', ['order' => request('order') === 'asc' ? 'desc' : 'asc', 'sort' => 'updated_at']) }}">
                                                                Date Modified
                                                ...
                                                <tbody class="content-list">
                                                    ...
                                                    <!-- Loop through each content item (file or folder) -->
                                                    @if ($contents->isNotEmpty())
                                            ...
                                            @else
                                                ...
                                                <tbody class="content-list">
                                                    <tr>
                                                        <td colspan="5" class="text-center">No file available.
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            @endif
...
@push('scripts')
    <!-- JavaScript for handling folder/file info, renaming, moving, copying, and trash actions -->
    <script>
        ...
        // Handle moving a file/folder to trash
        ...
        // Handle making a copy of a file/folder
